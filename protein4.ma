...
neighbors : 			   protein(2,-2)  protein(2,-1)  protein(2,0)  protein(2,1)  protein(2,2)
initialvalue : 0
%Example sequence: (HP)2PH(HP)2(PH)2HP(PH)2
initialrowvalue :  6     000002121122121121221121200000
...
% Compactness rule: move P to bottom if upper surface of H is more occupied
